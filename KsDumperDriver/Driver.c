...
NTSTATUS IoControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
    ...
    {
        if (stack->Parameters.DeviceIoControl.InputBufferLength == sizeof(KERNEL_MODULES_LIST_OPERATION) &&
            stack->Parameters.DeviceIoControl.OutputBufferLength == sizeof(KERNEL_MODULES_LIST_OPERATION))
        {
